...
def calc_fraction_mua_to_peak(spike_indices, sampling_rate,
...
class WorkItemSummary(object):
    ...
    def remove_redundant_neurons(self, neurons, overlap_time=2.5e-4, overlap_ratio_threshold=2):
        ...
        while True:
            ...
            # Our first check is easy, if one of the neurons is more than 2x the SNR
            # of the other neuron (on their primary channel, the lower SNR neuron is
            # removed.
            delete_1 = False
            delete_2 = False
            if neuron_1['snr'] > 2 * neuron_2['snr']:
                delete_2 = True
            elif neuron_2['snr'] > 2 * neuron_1['snr']:
                delete_1 = True
